...
export class ButtonsService implements OnDestroy{
  ...
  buttons: Buttons[] = [
    {
      help: false, left : true, color: this.color_of, unactive_visual_mode: false, disabled: false,
    ...
    {
      help: false, left : false, color: this.color_of, unactive_visual_mode: false, disabled: false,
